    ...
    return (
        <div id="home" className="mt-10 lg:mt-10 lg:flex lg:space-x-10">
            <div className="rounded-md border-2 border-neutral-700 h-110 w-full lg:w-8/12" >
                ...
                <div className="flex justify-between px-5 relative -top-1/2 -translate-y-6">
                ...
                <div className="flex relative -top-1/5 items-center justify-center w-full gap-1 opacity-50">
                    {imgSrc.map((_, index) => (
